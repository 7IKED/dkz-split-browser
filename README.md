...
![Lines](https://img.shields.io/badge/Lines-438-ffb800?style=for-the-badge)
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-split-browser.git

# Oeffnen
cd dkz-split-browser
